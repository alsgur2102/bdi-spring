...
<script>
	...
	window.addEventListener('load',function() {
		...
		/* var data = [{jpnum:1,jpname:"test1",jpdesc:"test data1"}	// [] : List(index를 갖고 있음), {} : Map(key,value값을 갖고 있음)
		,{jpnum:2,jpname:"test2",jpdesc:"test data2"}
		,{jpnum:3,jpname:"test3",jpdesc:"test data3"}];	
